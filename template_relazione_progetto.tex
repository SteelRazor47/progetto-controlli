...
\`E bene specificare che tutti i grafici riguardantila risposta a gradino del sistema non lineare sono stati traslati in basso del valore di $x_e$ al fine di ottenere una visualizzazione che partisse da $0$, così da semplificare
